...
dt_device = decision_tree.DecisionTree(loc+'/persona/MobilePrices_yaml/MobilePrices_rules.yml')
...
def append_persona(dt_loc = dt_loc, dt_device = dt_device, user_data = user_data):
    ...
    for cat in categories_loc:
        res = dt_loc.validate_persona_for_user(user_data=user_data,
                                               persona_data={},
    ...
    for cat in categories_device:
        res = dt_device.validate_persona_for_user(user_data=user_data,
                                                  persona_data={},
...
def reco_product(user_data = user_data):
    credit_cards = decision_tree.DecisionTree(loc+'/persona/products_yaml/credit_cards_rules.yml')
    credit_cards_dec = credit_cards.decisions
    bank_accounts = decision_tree.DecisionTree(loc+'/persona/products_yaml/bank_accounts_rules.yml')
    bank_accounts_dec = bank_accounts.decisions
    deposit_accounts = decision_tree.DecisionTree(loc+'/persona/products_yaml/deposit_accounts_rules.yml')
    ...
    packages = decision_tree.DecisionTree(loc+'/persona/products_yaml/packages_rules.yml')
    packages_dec = packages.decisions
    privilege_banking = decision_tree.DecisionTree(loc+'/persona/products_yaml/privilege_banking_rules.yml')
    ...
    for cat_ba in categories_ba:
        res_ba = bank_accounts.validate_user_for_product(user_data=user_data,
                                                         product_data={},
    ...
    for cat_da in categories_da:
        res_da = deposit_accounts.validate_user_for_product(user_data=user_data,
                                                            product_data={},
    ...
    for cat_pb in categories_pb:
        res_pb = privilege_banking.validate_user_for_product(user_data=user_data,
                                                             product_data={},
    ...
    for cat_loans in categories_loans:
        res_loans = loans.validate_user_for_product(user_data=user_data,
                                                    product_data={},
                                                    decisions=loans_dec,
                                                    category=cat_loans,
                                                    product='')
    ...
    for cat_packages in categories_packages:
        res_packages = packages.validate_user_for_product(user_data=user_data,
                                                          product_data={},
    ...
    for cat_cc in categories_cc:
        res_cc = credit_cards.validate_user_for_product(user_data=user_data,
                                                        product_data={},
