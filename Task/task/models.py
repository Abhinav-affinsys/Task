...
def reco(pk):
    ...
    main.reco_product()
    product = []
    product = main.user_data['recommended_cards']+main.user_data['recommended_loans']+main.user_data['recommended_packages']+main.user_data['recommended_privilege_banking']+main.user_data['recommended_deposit_accounts']+main.user_data['recommended_bank_accounts']
    message = ""
...
def mail(pk,flag=0):
    ...
    recipient_list = ["abhinav.nair@affinsys.com", ]
